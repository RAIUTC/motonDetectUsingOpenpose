...
#
# '''
# 웹캠 영상 캡쳐하기 위해 VideoCapture객체를 생성
...
#     exit()
#
# # 웹캠이 연결되어 있으면 계속해서 반복
# while webcam.isOpened():
#     # 웹캠에서 촬영되는 영상을 webcam.read()를 통해 읽어낸다.
#     # status 캡쳐에 성공을 알기 위한 변수
#     # frame 창에 캡쳐된 프레임을 보여주기 위한 변수
#     status, frame = webcam.read()
#
#     # webcam캡쳐에 성공했다면 test라는 창에 캡쳐된 프레임을 보여준다.
#     if status:
